...
const WHATSAPP_NUMBER = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "5548963406360";
const MENSAGEM = encodeURIComponent(
  "Olá! Vim pelo site e gostaria de saber mais sobre móveis planejados."
);
...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg animate-whatsapp-pulse hover:animate-none hover:scale-110 transition-transform"
    >
      {/* Ícone WhatsApp em SVG inline */}
      <svg
