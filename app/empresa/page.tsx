...
const diferenciais = [
  {
    titulo: "Projeto 3D incluso",
    descricao:
      "Você visualiza cada detalhe do seu ambiente antes da produção começar. Ajustes ilimitados até a aprovação final.",
  },
  {
    titulo: "Instalação própria",
    descricao:
      "Nossa equipe técnica cuida de toda a instalação. Sem terceirizados: precisão e responsabilidade do início ao fim.",
  },
  {
    titulo: "Materiais de alto padrão",
    descricao:
      "Trabalhamos com os melhores fornecedores do mercado. Acabamentos que duram décadas e valorizam o imóvel.",
  },
  {
    titulo: "Atendimento consultivo",
    descricao:
      "Não vendemos móveis. Desenvolvemos projetos. Nosso time entende suas necessidades antes de propor qualquer solução.",
  },
  {
    titulo: "Garantia total",
    descricao:
      "Suporte completo no pós-instalação. Qualquer ajuste necessário, nossa equipe atende com agilidade.",
  },
  {
    titulo: "Projeto personalizado",
    descricao:
      "Cada detalhe é pensado para o seu espaço e o seu estilo de vida. Não existem dois projetos iguais.",
  },
];
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {numeros.map((n) => (
              <div key={n.label} className="flex flex-col gap-1">
                <span className="font-yantra text-4xl md:text-5xl font-bold text-brand-bg">{n.valor}</span>
      ...
      <section className="py-12 md:py-20 bg-brand-surface">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Foto placeholder: equipe ou showroom */}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {diferenciais.map((d) => (
              ...
              >
                <div
                  className="w-8 h-8 rounded-sm bg-brand-ebony/10 flex items-center justify-center"
                  aria-hidden="true"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-[4/3] bg-brand-border rounded-md flex items-center justify-center order-2 lg:order-1">
              <div className="text-center text-brand-muted">
                ...
                <p className="text-sm mt-1">Google Maps embed — Fase 3</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6 order-1 lg:order-2">
              ...
              <h2 className="font-display text-3xl font-bold text-brand-dark">Atendemos toda a Grande Florianópolis.</h2>
              ...
              <ul className="flex flex-col gap-2 text-brand-muted text-sm">
                {["Florianópolis", "São José", "Palhoça", "Biguaçu", "Santo Amaro da Imperatriz"].map(
                  (cidade) => (
