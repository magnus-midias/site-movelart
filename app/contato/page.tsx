      ...
      <main id="main-content">
        ...
        <section className="pt-16 md:pt-20 bg-brand-bg border-b border-brand-border">
          <div className="container mx-auto py-10 md:py-16">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="bg-brand-surface border border-brand-border rounded-md p-6 md:p-8 lg:col-span-3">
                <ContactForm />
              </div>
        ...
        <section className="py-10 md:py-16 bg-brand-surface">
          <div className="container mx-auto">
            ...
            <div className="w-full h-64 md:h-80 bg-brand-border rounded-md flex items-center justify-center">
